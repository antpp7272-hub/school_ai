...
## Upgrade 3 — Rich AI Responses

เพิ่มความสามารถดังนี้:

- แสดง Markdown แบบปลอดภัย: หัวข้อ ตัวหนา รายการ ลิงก์ และข้อความอ้างอิง
- แปลงเว็บไซต์ อีเมล และเบอร์โทรเป็นลิงก์ที่กดได้
- ปุ่มคัดลอกคำตอบ
- ปุ่มถามต่อ โดยใช้บริบทจากคำตอบก่อนหน้า
- ปุ่มเลื่อนไปยังส่วนติดต่อโรงเรียน
- แสดงวันที่อัปเดตข้อมูลล่าสุดใต้คำตอบ
- ไม่ใช้ `innerHTML` จึงลดความเสี่ยงจาก HTML/XSS ที่ AI ส่งกลับมา
